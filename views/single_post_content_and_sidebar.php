                       ...
                       <div class="col-lg-8 posts-list">
                          <div class="single-post">
                             <div class="feature-img">
                                <img class="img-fluid" src="<?= $post->bigImage; ?>" alt="<?= $post->heading; ?>">
                             </div>
                             <div class="blog_details">
                                <h2><?= $post->heading; ?></h2>
         ...
         <div class="col-lg-4">
            <div class="blog_right_sidebar">
               <aside class="single_sidebar_widget search_widget">
                  <form action="admin/searchPost.php" method="POST">
                     <div class="form-group">
                        <div class="input-group mb-3">
                           <input name="tbHeading" type="text" class="form-control" placeholder='Search Keyword'
                     ...
                     <button class="button rounded-0 primary-bg text-white w-100 btn_1" name="btnSearch" type="submit">Search</button>
                  </form>
               </aside>
               <aside class="single_sidebar_widget post_category_widget">
                  <h4 class="widget_title">Category</h4>
                  <ul class="list cat-list">
                    <?php $categories = listCategory(); ?>
                    <?php foreach ($categories as $category): ?>
                       <li>
                          <a href="index.php?page=blog&category=<?= $category->id; ?>" class="d-flex">
                             <p><?= $category->name; ?></p>
                          </a>
                       </li>
                     <?php endforeach; ?>
