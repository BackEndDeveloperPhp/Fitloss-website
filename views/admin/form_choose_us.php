...
<div class="col-12 mt-5 mb-5">
  <div class="col-12">
    <h2 class="contact-title">Chouse us content</h2>
  </div>
  <div class="col-lg-12">
    <form class="form-contact contact_form" action="admin/insert_choose_us.php" method="post" id="contactForm" novalidate="novalidate" enctype='multipart/form-data'>
      <div class="row">
        <div class="col-12">
      ...
      <div class="form-group mt-3">
        <button type="submit" name="btnChoose" class="button button-contactForm btn_1">Insert</button>
      </div>
    </form>
</div>
</div>
